...
namespace cppai {
    namespace utility {
        ...
        void pretty_print(const boost::json::value& jvalue, std::uint16_t indent = 0u, std::uint16_t padding = 4u) {
        ...
        void pretty_print(boost::json::value&& jvalue, std::uint16_t indent = 0u, std::uint16_t padding = 4u) {
            const std::string indent_str(indent, ' ');
            switch (jvalue.kind()) {
            case boost::json::kind::object: {
                std::cout << "\n{\n";
    ...
    private:
        ...
        boost::asio::awaitable<boost::json::value> client(boost::beast::http::request<boost::beast::http::string_body>&& request) {
    ...
    public:
        ...
        boost::asio::awaitable<boost::json::value> model_list() {
        ...
        boost::asio::awaitable<boost::json::value> completion(const boost::json::value& request_body) {
        ...
        boost::asio::awaitable<boost::json::value> chat_completion(const boost::json::value& request_body) {
            boost::beast::http::request<boost::beast::http::string_body> chat_req;
            chat_req.method(boost::beast::http::verb::post);
            chat_req.set(boost::beast::http::field::host, host);
            chat_req.version(http_ver);
        ...
        boost::asio::awaitable<boost::json::value> edit(const boost::json::value& request_body) {
        ...
        boost::asio::awaitable<boost::json::value> create_image(const boost::json::value& request_body) {
        ...
        boost::asio::awaitable<boost::json::value> create_img_variation(boost::filesystem::path image, ::cppai::utility::img_req_builder opt_params = {}) {
            ::cppai::utility::img_req opt_vals = std::move(opt_params.req);
            boost::nowide::nowide_filesystem();
            boost::nowide::ifstream img_stream{ image, std::ios_base::binary };
            ...
            std::cout << img_var_req;

            boost::json::value img_var_res = co_await client(std::move(img_var_req));
            co_return img_var_res;
        }

        boost::asio::awaitable<boost::json::value> create_embedding(const boost::json::value& request_body) {
        ...
        boost::asio::awaitable<boost::json::value> files_list() {
        ...
        boost::asio::awaitable<boost::json::value> delete_file(std::string_view id) {
        ...
        boost::asio::awaitable<boost::json::value> retrieve_file(std::string_view id) {
        ...
        boost::asio::awaitable<boost::json::value> create_fine_tune(const boost::json::value& request_body) {
        ...
        boost::asio::awaitable<boost::json::value> list_fine_tunes() {
        ...
        boost::asio::awaitable<boost::json::value> retrieve_fine_tune(std::string_view id) {
        ...
        boost::asio::awaitable<boost::json::value> cancel_fine_tune(std::string_view id) {
        ...
        boost::asio::awaitable<boost::json::value> fine_tune_events(std::string_view id) {
        ...
        boost::asio::awaitable<boost::json::value> delete_fine_tune(std::string_view id) {
        ...
        boost::asio::awaitable<boost::json::value> create_moderations(const boost::json::value& request_body) {
